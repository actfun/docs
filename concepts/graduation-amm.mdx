...
description: "When 95% of supply is mined, a ACTFUN  token graduates automatically into a constant-product AMM seeded with LP reserve tokens and all accumulated ARC fees."
---
