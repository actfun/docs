...
<Tip>
  On Arc Testnet, the creation fee is set low to encourage experimentation. Check the current value by reading `creationFee` on the `LaunchpadFactory` contract at `0xD3a684B4D9aA0E92E79ade7DcaB70A8b125A7a4B`.
</Tip>
