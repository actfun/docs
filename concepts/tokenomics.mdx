...
Every time you mine, you pay `feePerMine` in ARC. That ARC is held in the contract's balance. It does **not** go to the creator. When the token graduates, the entire accumulated ARC balance becomes the ARC side of the AMM's initial liquidity — paired with the 5% LP reserve tokens.
