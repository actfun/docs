<div align="center">
  <img src="artifacts/actfun/public/actfun-logo.png" alt="ACTFUN" width="120" />

  # ACTFUN — Mine to Launch
  ...
  **The first community-mined token launchpad on Arc Network.**
  ...
  [![Docs](https://img.shields.io/badge/Docs-actfun.mintlify.app-blue?style=flat-square)](https://actfun.mintlify.app/quickstart)
...
| DEX | External (Raydium) | **Built-in AMM + UNITFLOW V3 + Uniswap V2 + Curve Finance (StableSwap)** |
...
│               • Seeds liquidity, split EVENLY across the  │
│                 AMMs the creator selected at launch       │
│                 (any non-empty subset of the three):     │
│                 – UNITFLOW V3 (Uniswap V3 fork) full-range LP
│                 – Uniswap V2 (classic constant-product)
│                 – Curve Finance (StableSwap) low-slippage pool
...
│               Or choose UNITFLOW V3, Uniswap V2, or Curve Finance.    │
│                                                         │
...
**LaunchpadFactory** (`0x87b0c4...0361`) deploys two contracts per token:
...
- **Buy tokens** — direct USDC → token swap via UNITFLOW V3 AMM
...
|---|---|---|
| LaunchpadFactory | [`0xD3a684B4D9aA0E92E79ade7DcaB70A8b125A7a4B`](https://testnet.arcscan.app/address/0xD3a684B4D9aA0E92E79ade7DcaB70A8b125A7a4B) | v15 (2026-05-31) |
...
| StableSwap Factory | `0x3714f242fe169AB5EB0D763Cf79AEAcA5F727E7b` | v2 — invariant math fix (2026-05-31) |
...
├── artifacts/actfun-video/        Animated promo video
...
| 📜 Factory contract | [0xD3a684...7a4B](https://testnet.arcscan.app/address/0xD3a684B4D9aA0E92E79ade7DcaB70A8b125A7a4B) |
