...
- **Buying** sends USDC in and receives tokens out: `tokensOut = usdcIn × tokenReserve / (usdcReserve + usdcIn)`
- **Selling** sends tokens in and receives USDC out: `usdcOut = tokensIn × usdcReserve / (tokenReserve + tokensIn)`
