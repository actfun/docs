...
Go to [actfun.xyz/create](https://actfun.fun/create). You need a connected MetaMask wallet on Arc Testnet and enough ARC to cover the creation fee plus gas. If you haven't done that yet, see [Connect your wallet](/guides/connect-wallet).
...
<Steps>
  ...
  <Step title="Set the ARC fee per mine">
