...
Browse tokens on [actfun.](https://actfun.fun)xyz and click any token card that interests you. This opens the token's detail page, where you can see its mining progress, activity feed, and the mining panel on the right.
