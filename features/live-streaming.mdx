...
description: "Token creators can broadcast live video directly from the ACTFUN token page. Viewers watch via WebRTC peer-to-peer with a live chat panel and real-time viewer count."
---
...
| Signalling | ACTFUN API server (WebSocket) |
